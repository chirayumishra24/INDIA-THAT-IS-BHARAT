...
export const HERITAGE_DROP_ZONES: HeritageDropZone[] = [
  // North
  { id: 'jammu-kashmir', name: 'Jammu & Kashmir', top: '13.5%', left: '28.5%' },
  { id: 'ladakh', name: 'Ladakh', top: '15.0%', left: '40.5%' },
  { id: 'himachal-pradesh', name: 'Himachal Pradesh', top: '22.0%', left: '36.0%' },
  { id: 'punjab', name: 'Punjab', top: '24.5%', left: '29.5%' },
  { id: 'haryana', name: 'Haryana', top: '28.5%', left: '33.5%' },
  { id: 'delhi', name: 'Delhi (NCT)', top: '29.5%', left: '38.0%' },
  { id: 'uttarakhand', name: 'Uttarakhand', top: '26.0%', left: '42.5%' },
  { id: 'uttar-pradesh', name: 'Uttar Pradesh', top: '35.5%', left: '43.5%' },
  // West
  { id: 'rajasthan', name: 'Rajasthan', top: '34.0%', left: '26.0%' },
  { id: 'gujarat', name: 'Gujarat', top: '44.5%', left: '16.5%' },
  { id: 'maharashtra', name: 'Maharashtra', top: '53.5%', left: '30.0%' },
  { id: 'goa', name: 'Goa', top: '61.5%', left: '25.5%' },
  // East & Central
  { id: 'madhya-pradesh', name: 'Madhya Pradesh', top: '47.0%', left: '39.5%' },
  { id: 'chhattisgarh', name: 'Chhattisgarh', top: '51.0%', left: '50.5%' },
  { id: 'bihar', name: 'Bihar', top: '37.0%', left: '57.0%' },
  { id: 'jharkhand', name: 'Jharkhand', top: '42.5%', left: '58.0%' },
  { id: 'west-bengal', name: 'West Bengal', top: '46.5%', left: '67.5%' },
  { id: 'odisha', name: 'Odisha', top: '55.5%', left: '62.0%' },
  // South
  { id: 'telangana', name: 'Telangana', top: '56.0%', left: '43.0%' },
  { id: 'andhra-pradesh', name: 'Andhra Pradesh', top: '64.0%', left: '49.0%' },
  { id: 'karnataka', name: 'Karnataka', top: '67.0%', left: '34.0%' },
  { id: 'kerala', name: 'Kerala', top: '79.5%', left: '31.5%' },
  { id: 'tamil-nadu', name: 'Tamil Nadu', top: '79.0%', left: '41.5%' },
  // North-East
  { id: 'sikkim', name: 'Sikkim', top: '32.0%', left: '69.0%' },
  { id: 'assam', name: 'Assam', top: '39.5%', left: '81.5%' },
  { id: 'arunachal-pradesh', name: 'Arunachal Pradesh', top: '33.0%', left: '88.0%' },
  { id: 'meghalaya', name: 'Meghalaya', top: '44.0%', left: '76.0%' },
  { id: 'nagaland', name: 'Nagaland', top: '39.0%', left: '92.0%' },
  { id: 'manipur', name: 'Manipur', top: '45.0%', left: '90.5%' },
  { id: 'mizoram', name: 'Mizoram', top: '50.0%', left: '87.5%' },
  { id: 'tripura', name: 'Tripura', top: '47.0%', left: '79.5%' }
];
